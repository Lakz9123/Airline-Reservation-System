...
public class ScheduledTasks {
    ...
    public ScheduledTasks(BookingRepository bookingRepository, EmailService emailService) {
        this.bookingRepository = bookingRepository;
        this.emailService = emailService;
    }

    /**
     * Runs every hour (and once shortly after startup) to find bookings
     * departing in 24 to 48 hours that haven't been checked in or reminded yet.
     */
